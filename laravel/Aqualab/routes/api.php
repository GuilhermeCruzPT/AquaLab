...
Route::get('/sensor-statistics', [StatisticsController::class, 'sensorStatistics']);
Route::post('/sensor-statistics', [StatisticsController::class, 'store']);
...
Route::middleware(['auth:api'])->group(function () {
    ...
    Route::post('/send-email', function (Request $request) {
        if ($request->hasFile('file')) {
            ...
            $path = $file->storeAs('pdfs', 'Aqualab_Relatorio.pdf', 'local');        
